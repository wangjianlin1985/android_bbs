	...
	protected void doPost(HttpServletRequest request,
		...
		if (action.equals("query")) {
			...
			if (request.getParameter("specialObj") != null)
				specialObj = request.getParameter("specialObj");
			...
			/*调用业务逻辑层执行学生信息查询*/
			List<Student> studentList = studentDAO.QueryStudent(studentNumber,specialObj,studentName,birthday);
			...
			for (int i = 0; i < studentList.size(); i++) {
				...
				.append("		<specialObj>")
				.append(studentList.get(i).getSpecialObj())
			...
			try {
			  ...
			  stringer.key("specialObj").value(student.getSpecialObj());
			...
			String specialObj = new String(request.getParameter("specialObj").getBytes("iso-8859-1"), "UTF-8");
