...
public class StudentDAO {
    ...
    public ArrayList<Student> QueryStudentInfo(String studentNumber,SpecialInfo specialObj,String studentName,String birthday,int currentPage) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From Student student where 1=1";
    	if(!studentNumber.equals("")) hql = hql + " and student.studentNumber like '%" + studentNumber + "%'";
    	if(null != specialObj && !specialObj.getSpecialNumber().equals("")) hql += " and student.specialObj.specialNumber='" + specialObj.getSpecialNumber() + "'";
    ...
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public ArrayList<Student> QueryStudentInfo(String studentNumber,SpecialInfo specialObj,String studentName,String birthday) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From Student student where 1=1";
    	if(!studentNumber.equals("")) hql = hql + " and student.studentNumber like '%" + studentNumber + "%'";
    	if(null != specialObj && !specialObj.getSpecialNumber().equals("")) hql += " and student.specialObj.specialNumber='" + specialObj.getSpecialNumber() + "'";
    ...
    /*计算总的页数和记录数*/
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public void CalculateTotalPageAndRecordNumber(String studentNumber,SpecialInfo specialObj,String studentName,String birthday) {
        Session s = factory.getCurrentSession();
        String hql = "From Student student where 1=1";
        if(!studentNumber.equals("")) hql = hql + " and student.studentNumber like '%" + studentNumber + "%'";
        if(null != specialObj && !specialObj.getSpecialNumber().equals("")) hql += " and student.specialObj.specialNumber='" + specialObj.getSpecialNumber() + "'";
