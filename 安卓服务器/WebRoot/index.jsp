...
<html>
<head>
<title>基于Android大学校园生活交流系统-首页</title>
...
<div id="container">
	...
	<div id="globallink">
		<ul>
			...
			<li><a href="<%=basePath %>Topic/Topic_FrontQueryTopic.action" target="OfficeMain">话题</a></li> 
			<li><a href="<%=basePath %>Comment/Comment_FrontQueryComment.action" target="OfficeMain">评论</a></li> 
			<li><a href="<%=basePath %>Friend/Friend_FrontQueryFriend.action" target="OfficeMain">好友信息</a></li> 
		</ul>
		<br />
	</div> 
	<div id="main">
