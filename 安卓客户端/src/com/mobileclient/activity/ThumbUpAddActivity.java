...
public class ThumbUpAddActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.thumbup_add); 
		ImageView search = (ImageView) this.findViewById(R.id.search);
		search.setVisibility(View.GONE);
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("添加点赞信息");
			...
			public void onClick(View v) {
				try {
					...
					if(ET_thumpTime.getText().toString().equals("")) {
						Toast.makeText(ThumbUpAddActivity.this, "点赞时间输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传点赞信息信息*/
					ThumbUpAddActivity.this.setTitle("正在上传点赞信息信息，稍等...");
					String result = thumbUpService.AddThumbUp(thumbUp);
