				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new StudentSimpleAdapter(StudentListActivity.this, list,
	        					...
	        					new String[] { "studentNumber","specialObj","studentName","sex","birthday","studentPhoto" },
	        					new int[] { R.id.tv_studentNumber,R.id.tv_specialObj,R.id.tv_studentName,R.id.tv_sex,R.id.tv_birthday,R.id.iv_studentPhoto,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < studentList.size(); i++) {
				...
				map.put("specialObj", studentList.get(i).getSpecialObj());
