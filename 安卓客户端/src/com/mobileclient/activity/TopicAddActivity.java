	...
	public void onCreate(Bundle savedInstanceState) {
		...
		iv_photo.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(TopicAddActivity.this,photoListActivity.class);
			...
			public void onClick(View v) {
				try {
					...
					if(ET_title.getText().toString().equals("")) {
						Toast.makeText(TopicAddActivity.this, "标题输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(topic.getPhoto() != null) {
						...
						TopicAddActivity.this.setTitle("正在上传图片，稍等...");
						String photo = HttpUtil.uploadFile(topic.getPhoto());
						TopicAddActivity.this.setTitle("图片上传完毕！");
						topic.setPhoto(photo);
					} else {
						topic.setPhoto("upload/noimage.jpg");
					}
					/*验证获取内容*/ 
					if(ET_content.getText().toString().equals("")) {
						Toast.makeText(TopicAddActivity.this, "内容输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_addTime.getText().toString().equals("")) {
						Toast.makeText(TopicAddActivity.this, "发布时间输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传话题信息*/
					TopicAddActivity.this.setTitle("正在上传话题信息，稍等...");
