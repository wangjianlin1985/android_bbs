...
public class StudentService {
	...
	public String AddStudent(Student student) {
		...
		params.put("specialObj", student.getSpecialObj());
		...
		params.put("memo", student.getMemo());
	...
	public List<Student> QueryStudent(Student queryConditionStudent) throws Exception {
		...
		if(queryConditionStudent != null) {
			...
			urlString += "&specialObj=" + URLEncoder.encode(queryConditionStudent.getSpecialObj(), "UTF-8") + "";
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				student.setSpecialObj(object.getString("specialObj"));
				...
				student.setMemo(object.getString("memo"));
